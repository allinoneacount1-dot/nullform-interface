import { P as PublicKey } from "../solana__web3.js.mjs";
import { q as BaseMessageSignerWalletAdapter, a as WalletReadyState, j as WalletDisconnectedError, d as WalletPublicKeyError, s as scopePollingDetectionStrategy, r as isIosAndRedirectable, b as WalletNotReadyError, t as WalletLoadError, m as WalletConfigError, e as WalletConnectionError, k as WalletDisconnectionError, c as WalletNotConnectedError, n as isVersionedTransaction, W as WalletError, g as WalletSendTransactionError, h as WalletSignTransactionError, f as WalletSignMessageError } from "../solana__wallet-adapter-base.mjs";
...
class SolflareWalletAdapter extends BaseMessageSignerWalletAdapter {
  ...
  async connect() {
    try {
      ...
      let SolflareClass;
      try {
        SolflareClass = (await import("../solflare-wallet__sdk.mjs")).default;
      } catch (error) {
