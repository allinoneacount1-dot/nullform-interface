import { s as startScenario, S as SolanaMobileWalletAdapterError, a as SolanaMobileWalletAdapterErrorCode } from "./mobile-wallet-adapter-protocol+[...].mjs";
  ...
  */
  ...
  #performSignIn = async (input) => {
    ...
    try {
      ...
      return {
        account: {
          ...signedInAccount ?? { address: bs58.encode(toUint8Array(signedInAddress)) },
      ...
      try {
        ...
        if (parsed && parsed.accounts) {
          const parsedAccounts = parsed.accounts.map((account) => {
            return {
              ...account,
              publicKey: "publicKey" in account ? new Uint8Array(Object.values(account.publicKey)) : bs58.decode(account.address)
            };
          });
          return {
            ...parsed,
