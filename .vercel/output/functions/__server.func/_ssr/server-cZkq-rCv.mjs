...
async function getStartManifest(matchedRoutes) {
  const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-oWe7DKml.mjs");
...
const manifest = {
  "0ac11fbf6bd3b8662d49e4bd2e6785181eaad15f270999afe690476db770dc59": {
    functionName: "getPurgeFeed_createServerFn_handler",
    importer: () => import("./purge.functions-w6Y7sPFy.mjs")
  },
  "0fd86b915028ec21790ba6558b0606712c2c00b85e9c28b145055e250507412f": {
    functionName: "getAuthNonce_createServerFn_handler",
    importer: () => import("./auth.functions-BFUdiGzJ.mjs")
  },
  "458ca223179642a618852e7e6a915ebc4c5aa34505b0ff6783fd7fe509e0c46e": {
    functionName: "getNullConfig_createServerFn_handler",
    importer: () => import("./null-config.functions-DvEEO8UB.mjs")
  },
  "887db650779822a61d54615421fd86dab087e8c362a1b2971ac608e3eaf93a51": {
    functionName: "verifyAuthSignature_createServerFn_handler",
    importer: () => import("./auth.functions-BFUdiGzJ.mjs")
  },
  "b28c72d5c19cb2360284b3c0a6709dcb8ad013f29a442bb69f315fd7d0d80e38": {
    functionName: "getAuthSession_createServerFn_handler",
    importer: () => import("./auth.functions-BFUdiGzJ.mjs")
  },
  "e48a6d946cd46f8952216be2bd7226ffa0493fbdf8e353305c5e102ae216f085": {
    functionName: "logoutAuth_createServerFn_handler",
    importer: () => import("./auth.functions-BFUdiGzJ.mjs")
  }
};
...
async function loadEntries() {
  const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
    import("./router-BKAa0bBg.mjs"),
    import("./start-DaZcIX38.mjs"),
